...
Public Class Program
    ...
    <ImportMany()> _
    Private Property CalculosNacionalizado As IEnumerable(Of Lazy(Of ICalculoNacionalizado, ICalculoNacionalizadoData))
    ...
    Private Sub Filter()
        ...
        For Each i As Lazy(Of ICalculoNacionalizado, ICalculoNacionalizadoData) In CalculosNacionalizado
            If i.Metadata.MEFCountry = countryToUse Then
                _CalculoNacionalizado = i.Value
            End If
        Next

        '_CalculoNacionalizado = (From calculo In Me.CalculosNacionalizado Where calculo.m= countryToUse Select calculo).LastOrDefault
